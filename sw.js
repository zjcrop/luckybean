...
const CORE = [
  ...
  './src/v095-ui.js?v=1.1.0-test',
  './src/theme-bridge.js?v=1.1.0-test',
  ...
  './src/v099-trajectory-signal-bridge.js?v=1.1.0-test',
  './src/v099i-trajectory-space.js?v=1.1.0-test',
