...
assert.match(index, /src\/core\/startup-controller\.js\?v=1\.24B-main\.13-local-menu-prompt/);
...
assert.match(startup, /APP_MODULE_REVISION\s*=\s*'1\.24B-main\.13-local-menu-prompt'/);
