...
const codecFacade = read('src/cloud-codec.js');
const codec = read('src/cloud-codec-base.js');
...
// The P2 lifecycle layer is a facade over the stable v2 codec. Gear serialization stays
// in the unchanged base implementation, while the public cloud-codec module must keep
// forwarding those exports for all existing callers.
assert.match(codecFacade, /export \* from '\.\/cloud-codec-base\.js'/);
...
console.log('LuckyBean 1.23E gear cloud-sync compatibility checks passed through the P2 codec facade');
