...
assert.ok(sw.includes('CACHE_NAME = `${CACHE_PREFIX}main-4-interaction3`'), 'service worker cache generation must match current release');
...
console.log('LuckyBean 1.24B canonical QR, bean matching, gear, flavor taxonomy, user-guide and interaction3 release checks passed');
