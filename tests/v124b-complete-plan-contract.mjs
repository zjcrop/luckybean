...
assert.match(groupNav,/button\[data-v099t-group-back\]/);
assert.match(groupNav,/folder-style group navigation active/);
...
for(const file of ['release-1.24b-freshness-detail.js','recognition-batch-progress-controller.js','recognition-field-resolver-1.24b.js','release-1.24b-transit-controller.js','release-1.24b-group-navigation.js','release-1.24b-about-controller.js','release-1.24b-brew-mode-controller.js','release-1.24b-ui-policy.js','local-brew-recipes-1.24b.js','grind-psd-reference-service.js','order-recognition-1.24b.js']) assert.ok(sw.includes(file),`service worker missing ${file}`);
