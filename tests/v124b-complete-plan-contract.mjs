...
assert.match(groupNav,/LuckyBeanV099tBeanGroups/);
assert.match(groupNav,/api\.closeActiveGroup/);
assert.match(groupNav,/canonical folder-state navigation active/);
assert.match(groupNav,/capture:true/);
assert.match(groupNav,/dx<=-72/);
assert.match(groupNav,/luckybean:navigation-back/);
assert.doesNotMatch(groupNav,/data-v099t-group-back|back\.click|\.bean-grid/);
...
console.log('LuckyBean 1.24B main.4 complete modification-plan contract with canonical groups, shared sorting and text brew UI passed');
