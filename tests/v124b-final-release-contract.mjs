...
for (const file of ['release-1.24b-ui-policy.js','release-1.24b-brew-mode-controller.js','release-1.24b-freshness-detail.js','recognition-batch-progress-controller.js','sensory-tag-sort-controller.js']) assert.ok(runtime.includes(file), `runtime graph must load ${file}`);
